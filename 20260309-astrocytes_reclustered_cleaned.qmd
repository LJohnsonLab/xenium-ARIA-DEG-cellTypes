...
akhil <- c("Cx3cr1", "Itgax", "Cd68",
  "C1qa", "C1qb", "C1qc", "Icam1", "Vcam1",
  "Lyz2", "Cd14", "Cst7", "Siglech", "Clec7a", "Cst3",
  "Gpnmb", "Pf4", "Chil3", "Ly86", "Cd81", "Nkg7",
  "Mki67","Mbp", "Mag", "Plp")

genes_to_remove <- c(markers, akhil)
...
## save cleaned object
# qs_save(astro, "seurat_objects/20260317-astro_cleaned2_0.3.qs2")
```
```{r}

## load cleaned object
astro <- qs2::qs_read("seurat_objects/20260317-astro_cleaned2_0.3.qs2")
```
...
![Original reclustering](img/astrocyte_UMAP_reclusteredOriginal.svg){width=100% height=500px}

![After removing cluster 6](img/astrocyte_UMAP_removedCluster6.png){width=100% height=500px}
...
DimPlot(astro, label =T, label.size = 6, pt.size =0.9)+ NoLegend() +
  ggtitle("Removed cluster 6 and 106 marker genes") 
```
...
# write_csv(all_markers, file = "results/20260317-astrocyte_cleaned_all_markers_0.3.csv")
```
...
top_genes <- read_csv("results/20260317-astrocyte_cleaned_all_markers_0.3.csv",
